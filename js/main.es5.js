...
var showBrowser = function showBrowser() {
    //navigate
    window.location.href = "browser.php";
};

var showSave = function showSave() {
    //don't navigate
};

var showGit = function showGit() {
    //navigate
...
$.preloadImages("img/folder-hover.png", "img/file-hover.png", "img/folder-up-hover.png");
